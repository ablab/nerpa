...
def visualize_prediction(detailMolFN, predictionFN, molName, genomeName, request_id, nrpDB, show_genome_name, antismash):
    ...
    model_object = MatchingResult(request_id=request_id, innerTableHTML=innerHTML, orfsInfo=orfsInfo,
                                  ...
                                  AA_number=cntAA, AA_matching_number=cntMatchAA, linkToAntismash=antismash)
